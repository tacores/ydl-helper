...
class YdlHelperTest(unittest.TestCase):
	def setUp(self):
		...
		self.sut = ydl_helper.YdlPlaylistHelper(self.setting_stub, self.fs_stub, self.subp_spy, self.sys_stub)
	...
	def test_save_start_position_2files_downloaded(self):
		...
		filenames = [['videoname1','nextname2'],['videoname1','nextname2', 'downname3','loadname4']]
	...
	def test_not_count_uncomplete_file(self):
		...
		filenames = [['videoname1','nextname2'],['videoname1','nextname2', 'downname3','loadname4.part']] # .part
